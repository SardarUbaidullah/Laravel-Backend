...
<body>
  ...
  <div class="hero_area">
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{route('booking')}}">Book Table</a>
              </li>
            </ul>
    ...
    <footer class="footer_section">
        <div class="container">
          ...
          <div class="footer-info">
            <p>
              ...
              <a href="https://sardarubaid.netlify.app/">SardarUbaid</a><br><br>
              &copy; 
            </p>
          </div>
        </div>
      ...
      <!-- bootstrap js -->
      <script src="{{asset('/assests/js/bootstrap.js')}}"></script>
      <!-- owl slider -->
